...
struct StoredCredentials {
    static func save(apiKey: String, customerID: String, token: String, refreshToken: String) {
    ...
    static func load() -> (apiKey: String, customerID: String, token: String, refreshToken: String)? {
        ...
        return (apiKey, customerID, token, refreshToken)
    }
